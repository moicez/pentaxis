...
SolverInfoProcessor::SolverInfoProcessor(const urdf::ModelInterface &robot_model,
...
SolverInfoProcessor::getSolverInfo() const
{
  return _solver_info;
}

void
SolverInfoProcessor::addJointToChainInfo(
